...
```{r medtable, tab.cap = 'Table 1: Selected Medication Abbreviations Found', out.width="100%"}

med_list %>% kable() %>% kable_classic()

```

***Funding Acknowledgements***
Alexeev---Biomedical Informatics and Data Science Research Training Program, T15LM007092-30, PI Dr. Nils Gehlenborg, PhD; Ozonoff, Landschaft, Kimia---AHRQ Research Grant 5R01HS026246
